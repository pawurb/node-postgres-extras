...
The package expects the environment variable `DATABASE_URL` value in the following format:
...
PostgresExtras.index_cache_hit()
...
PostgresExtras.table_cache_hit()
...
PostgresExtras.total_index_size()
...
PostgresExtras.table_indexes_size()
...
PostgresExtras.total_table_size()
...
PostgresExtras.long_running_queries()
